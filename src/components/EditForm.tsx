...
const EditForm: React.FC = (props:any) => {
  ...
  return (
    <>
      ...
      <Modal open={isShow} onCancel={()=>{setIsShow(false)}} title="Hotel Agent Admin Page" footer={[]}> 
    <p></p>
    {props.isNew?(<Title level={3} style={{color:"#0032b3"}}>Create New Hotel info</Title>):(<Title level={3} style={{color:"#0032b3"}}>Update Article</Title>)}
